  ...
  if (!validImages || urls.length === 0) {
    return (
      <View style={styles.noImageBox}>
        <Icon name="local-florist" size={64} color={THEME.colors.muted} />
...
const StockBadge = ({ stock }) => {
  ...
  return (
    <View style={[styles.stockBadge, inStock ? styles.stockIn : styles.stockOut]}>
      <Icon name={inStock ? 'check-circle' : 'cancel'} size={14} color={inStock ? THEME.colors.success : THEME.colors.danger} />
      ...
      <SafeAreaView style={styles.safeArea}>
            ...
            <View style={styles.detailsCard}>
              <View style={styles.chipRow}>
                <View style={styles.categoryChip}>
                  <Icon name="category" size={13} color={THEME.colors.accent} />
              ...
              {product.isOnSale && product.discountStartDate && product.discountEndDate && (
                <View style={styles.discountPeriodContainer}>
                  <Icon name="event" size={16} color={THEME.colors.sale} />
                ...
                <>
                  ...
                  {product.brand && (
                    <View style={styles.infoRow}>
                      <Icon name="storefront" size={18} color={THEME.colors.accent} />
                  ...
                  {product.weight && (
                    <View style={styles.infoRow}>
                      <Icon name="fitness-center" size={18} color={THEME.colors.accent} />
        ...
        <View style={styles.bottomBar}>
          <TouchableOpacity
            ...
            activeOpacity={0.8}
            accessibilityLabel="Add this product to cart"
          >
            {cartLoading ? (
              <ActivityIndicator size="small" color={THEME.colors.accent} />
            ) : (
              <Icon name="add-shopping-cart" size={20} color={THEME.colors.accentDark} />
            )}
          </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  centered: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: THEME.colors.bg, gap: 12 },
  loadingText: { fontSize: 15, color: THEME.colors.muted, marginTop: 8 },
  notFoundText: { fontSize: 18, fontWeight: '700', color: THEME.colors.text, marginTop: 12 },
  backBtn: { marginTop: 16, paddingHorizontal: 24, paddingVertical: 10, backgroundColor: THEME.colors.accent, borderRadius: THEME.radius.pill },
  ...
  carouselContainer: { backgroundColor: THEME.colors.surface },
  ...
  noImageText: { color: THEME.colors.muted, fontSize: 14, marginTop: 8 },
  imageCounter: {
    position: 'absolute',
    top: 14,
    right: 14,
  ...
  dot: { width: 7, height: 7, borderRadius: 4, backgroundColor: 'rgba(255,255,255,0.55)', marginHorizontal: 3 },
  dotActive: { backgroundColor: THEME.colors.accent, width: 16, height: 6, borderRadius: 4 },
  thumbnailStrip: { backgroundColor: THEME.colors.surface, borderTopWidth: 1, borderTopColor: THEME.colors.border },
  thumbnailContent: { paddingHorizontal: 12, paddingVertical: 10 },
  thumbnail: { width: 60, height: 60, borderRadius: 10, marginRight: 8, borderWidth: 2, borderColor: 'transparent' },
  thumbnailActive: { borderColor: THEME.colors.accent },
  detailsCard: {
    backgroundColor: THEME.colors.surface,
  ...
  chipRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 10, gap: 8 },
  categoryChip: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  categoryChipText: { fontSize: 12, color: THEME.colors.accentDark, fontWeight: '700', marginLeft: 4 },
  discountBadge: {
  ...
  discountBadgeText: { color: THEME.colors.sale, fontSize: 12, fontWeight: '700' },
  productName: { fontSize: 22, fontWeight: '800', color: THEME.colors.text, marginBottom: 12, lineHeight: 30 },
  priceContainer: { flexDirection: 'row', alignItems: 'center', flexWrap: 'wrap', marginBottom: 8 },
  productPrice: { fontSize: 28, fontWeight: '900', color: THEME.colors.accentDark },
  originalPrice: { fontSize: 18, color: THEME.colors.muted, textDecorationLine: 'line-through', marginRight: 10 },
  discountBadgeLarge: {
  ...
  discountBadgeLargeText: { color: 'white', fontSize: 14, fontWeight: '700' },
  ...
  discountPeriodText: { marginLeft: 8, fontSize: 14, color: THEME.colors.sale, fontWeight: '600' },
  priceStockRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-start', marginBottom: 16 },
  stockBadge: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 20 },
  stockIn: { backgroundColor: THEME.colors.accentSoft },
  stockOut: { backgroundColor: '#FEE2E2' },
  stockText: { fontSize: 13, fontWeight: '600', marginLeft: 4 },
  stockTextIn: { color: THEME.colors.accentDark },
  ...
  reviewsSummaryTitle: { fontSize: 16, fontWeight: '700', color: THEME.colors.text },
  viewAllReviewsButton: { paddingHorizontal: 8, paddingVertical: 4 },
  viewAllReviewsText: { fontSize: 12, color: THEME.colors.accent, fontWeight: '700' },
  averageRatingContainer: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  averageRatingText: { fontSize: 24, fontWeight: '800', color: THEME.colors.text },
  totalReviewsText: { fontSize: 13, color: THEME.colors.muted },
  writeReviewButton: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',
  ...
  reviewerAvatarText: { color: 'white', fontSize: 18, fontWeight: '700' },
  ...
  ratingText: { fontSize: 12, color: THEME.colors.muted, marginLeft: 4, fontWeight: '500' },
  reviewModalContainer: { flex: 1, justifyContent: 'flex-end', backgroundColor: 'rgba(0, 0, 0, 0.5)' },
  reviewModalContent: {
    backgroundColor: THEME.colors.surface,
  ...
  reviewModalTitle: { fontSize: 18, fontWeight: '700', color: THEME.colors.text },
  reviewProductInfo: {
    flexDirection: 'row',
    alignItems: 'center',
    marginBottom: 20,
  ...
  reviewProductImageContainer: { width: 50, height: 50, borderRadius: 10, overflow: 'hidden', marginRight: 12 },
  reviewProductImage: { width: '100%', height: '100%' },
  ...
  reviewProductName: { flex: 1, fontSize: 14, fontWeight: '600', color: THEME.colors.text },
  ratingContainer: { marginBottom: 20 },
  ratingLabel: { fontSize: 14, fontWeight: '600', color: THEME.colors.text, marginBottom: 8 },
  commentContainer: { marginBottom: 20 },
  commentLabel: { fontSize: 14, fontWeight: '600', color: THEME.colors.text, marginBottom: 8 },
  commentInput: {
    borderWidth: 1,
    borderColor: THEME.colors.border,
    borderRadius: 10,
  ...
  submitReviewButton: { backgroundColor: THEME.colors.accent, paddingVertical: 12, borderRadius: 10, alignItems: 'center' },
  submitButtonDisabled: { opacity: 0.6 },
  submitReviewText: { fontSize: 16, fontWeight: '700', color: 'white' },
  ...
  descriptionText: { fontSize: 15, color: '#4B5B4A', lineHeight: 24 },
  infoRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 6 },
  infoLabel: { fontSize: 14, color: THEME.colors.muted, flex: 0.3, marginLeft: 8 },
  infoValue: { fontSize: 14, color: THEME.colors.text, fontWeight: '600', flex: 0.7 },
  bottomBar: {
    flexDirection: 'row',
    paddingHorizontal: 16,
    paddingTop: 12,
  ...
  buyButtonText: { fontSize: 15, fontWeight: '800', color: 'white', letterSpacing: 0.25 },
