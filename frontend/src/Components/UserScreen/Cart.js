...
const getDB = async () => {
  ...
  try {
    _db = await SQLite.openDatabaseAsync('sproutify.db');
  ...
  if (urls.length === 0) {
    return (
      <View style={styles.itemImagePlaceholder}>
        <Icon name="local-florist" size={28} color={THEME.colors.muted} />
      </View>
    );
  }
  ...
  return (
    <View style={styles.cartItem}>
      ...
      <View style={styles.itemInfo}>
        ...
        <View style={styles.qtyRow}>
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <Icon name="remove" size={16} color={THEME.colors.accentDark} />
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.7}
          >
            <Icon name="add" size={16} color={THEME.colors.accentDark} />
          </TouchableOpacity>
      ...
      <TouchableOpacity
        ...
        activeOpacity={0.7}
      >
        <Icon name="delete-outline" size={24} color={THEME.colors.muted} />
      </TouchableOpacity>
    </View>
  );
};
      ...
      <SafeAreaView style={styles.safeArea}>
          ...
          {cartItems.length > 0 && (
            <View style={styles.topBarActions}>
              ...
              <TouchableOpacity
                ...
                activeOpacity={0.7}
              >
                <Icon name="delete-sweep" size={20} color={THEME.colors.sale} />
        ...
        {cartItems.length === 0 ? (
          <View style={styles.emptyContainer}>
            <Icon name="local-florist" size={90} color={THEME.colors.border} />
            <Text style={styles.emptyTitle}>Your cart is empty</Text>
            <Text style={styles.emptySubtitle}>
              Add plants and tools from the shop to get started
            </Text>
            <TouchableOpacity
          ...
          <>
            <FlatList
              ...
              refreshControl={
                <RefreshControl refreshing={refreshing} onRefresh={onRefresh} colors={[THEME.colors.accent]} tintColor={THEME.colors.accent} />
              }
              ListFooterComponent={
...
const styles = StyleSheet.create({
  ...
  loadingText: { fontSize: 15, color: THEME.colors.muted, marginTop: 12 },
  topBar: {
  ...
  topBarTitle: { fontSize: 22, fontWeight: '800', color: THEME.colors.text },
  topBarSubtitle: { fontSize: 13, color: THEME.colors.muted, marginTop: 2 },
  topBarActions: {
    flexDirection: 'row',
    alignItems: 'center',
  },
  ...
  clearBtn: {
    ...
    backgroundColor: THEME.colors.saleSoft, paddingHorizontal: 12, paddingVertical: 7, borderRadius: 20,
  },
  clearBtnText: { fontSize: 13, fontWeight: '600', color: THEME.colors.sale, marginLeft: 5 },
  ...
  emptySubtitle: { fontSize: 14, color: THEME.colors.muted, textAlign: 'center', lineHeight: 22, marginTop: 6 },
  shopNowBtn: {
    flexDirection: 'row', alignItems: 'center',
    backgroundColor: THEME.colors.accent, paddingHorizontal: 24, paddingVertical: 13,
    borderRadius: THEME.radius.pill, marginTop: 20,
  },
  shopNowText: { fontSize: 15, fontWeight: '700', color: 'white', marginLeft: 7 },
  listContent: { paddingHorizontal: 14, paddingTop: 14 },
  cartItem: {
    flexDirection: 'row', backgroundColor: THEME.colors.surface, borderRadius: 14,
    marginBottom: 12, padding: 12, alignItems: 'center', borderWidth: 1, borderColor: THEME.colors.border,
    elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 1 },
    shadowOpacity: 0.07, shadowRadius: 4,
  },
  itemImageBox: {
    width: 88, height: 88, borderRadius: 10,
    overflow: 'hidden', backgroundColor: THEME.colors.surfaceAlt, marginRight: 12,
  },
  ...
  itemImagePlaceholder: {
    flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: THEME.colors.surfaceAlt,
  },
  carouselArrowLeft: {
  ...
  carouselDotActive: { backgroundColor: THEME.colors.accent, width: 10, height: 5, borderRadius: 3 },
  itemInfo: { flex: 1 },
  itemName: { fontSize: 14, fontWeight: '700', color: THEME.colors.text, marginBottom: 3, lineHeight: 20 },
  priceContainer: {
    flexDirection: 'row',
    alignItems: 'center',
    flexWrap: 'wrap',
  ...
  itemPrice: { fontSize: 15, fontWeight: '800', color: THEME.colors.accentDark },
  discountedPrice: {
  ...
  qtyBtn: {
    ...
    backgroundColor: THEME.colors.accentSoft, borderWidth: 1, borderColor: '#B7D8BA',
    justifyContent: 'center', alignItems: 'center',
  },
  qtyBtnDisabled: { opacity: 0.4 },
  qtyText: { fontSize: 15, fontWeight: '700', color: THEME.colors.text, minWidth: 26, textAlign: 'center' },
  subtotalText: { fontSize: 12, color: THEME.colors.muted, marginLeft: 6 },
  removeBtn: { padding: 6, marginLeft: 4 },
  summaryCard: {
    backgroundColor: THEME.colors.surface, borderRadius: 16, padding: 18, marginTop: 4,
    borderWidth: 1, borderColor: THEME.colors.border,
    elevation: 2, shadowColor: '#000', shadowOffset: { width: 0, height: 1 },
    shadowOpacity: 0.07, shadowRadius: 4,
  },
  summaryTitle: { fontSize: 16, fontWeight: '800', color: THEME.colors.text, marginBottom: 14 },
  summaryRow: { 
    flexDirection: 'row', 
  ...
  summaryItemPrice: { fontSize: 13, fontWeight: '600', color: THEME.colors.text },
  savingsRow: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: THEME.colors.accentSoft,
  ...
  summaryTotalValue: { fontSize: 22, fontWeight: '900', color: THEME.colors.accentDark },
  checkoutBar: {
  ...
  checkoutTotalLabel: { fontSize: 12, color: THEME.colors.muted, fontWeight: '500' },
  checkoutTotalValue: { fontSize: 20, fontWeight: '900', color: THEME.colors.text },
  checkoutBtn: {
    flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
    backgroundColor: THEME.colors.accent, paddingVertical: 15, borderRadius: 14, gap: 8,
  },
